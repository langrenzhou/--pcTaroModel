...
class Logins extends Taro.Component {
  ...
  render() {
    return <View>
            <View>
                {this.state.userLogins ? <View><Text onClick={() => {
            this.setState({ isOpened: !this.state.isOpened });
          }}> 登陆/注册 </Text>  </View> : <View onClick={() => {
          Taro.navigateTo({ url: '/pages/Anchor/anchor' });
        }}>   <AtAvatar circle size="small" image={localStorage.avatar} /></View>}
            </View>
            <AtModal isOpened={this.state.isOpened}>
              ...
              this.setState({ current: e, userName: '', passWord: '', nikName: '', userEmail: '' });
                  ...
                  this.setState({ userName: value });return value;
                                ...
                                <AtInput name="value" title="密码:" type="password" placeholder="请输入您的密码" value={this.state.passWord} onChange={value => {
